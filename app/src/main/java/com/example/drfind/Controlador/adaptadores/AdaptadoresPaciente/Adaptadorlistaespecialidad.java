...
import com.example.drfind.Vista.Fragments.FragmentsPacientes.ListaMedicosfragment;
...
public class Adaptadorlistaespecialidad extends RecyclerView.Adapter<Adaptadorlistaespecialidad.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView especialidadnombre, idespeci,usus;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            usus=(TextView)itemView.findViewById(R.id.idusupaci);
        }
        ...
        public void onClick(View view) {
            ...
            datosAEnviar.putString("id",especialidadnombre.getText().toString());
            datosAEnviar.putString("usus",(usus.getText().toString()));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.usus.setText(especilista.get(position).getUsuariopa());
